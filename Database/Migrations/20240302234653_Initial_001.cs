    ...
    public partial class Initial_001 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueHubUserProject", x => new { x.MembersId, x.ProjectsId });
                    table.ForeignKey(
                        name: "FK_IssueHubUserProject_AspNetUsers_MembersId",
                        column: x => x.MembersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IssueHubUserProject_Projects_ProjectsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueHubUserProject_ProjectsId",
                table: "IssueHubUserProject",
                column: "ProjectsId");
